                            ...
                            <q-tab-panels v-model="tab" animated>
                                <q-tab-panel name="contatos">
                                    <q-markup-table flat bordered>
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in state.entidadeSite.contatos" :key="index"
                                            :class="{ 'az-tipo-menu': item.items }" draggable="true"
                                            @dragover="(e) => onDragOver(item, index, e)"
                                            @dragend="(e) => finishDrag(state.entidadeSite.contatos, item, index, e)"
                                ...
                                <q-tab-panel name="menu">
                                    <q-markup-table flat bordered>
                                        ...
                                        <tbody>
                                            <tr :class="{ 'az-tipo-menu': item.items }" draggable="true"
                                             @dragover="(e) => onDragOver(item, index, e)" 
            @dragend="(e) => finishDrag(listConteudo, item, index, e)"
            @dragstart="(e) => startDrag(item, index, e)"
                                            v-for="(item, index) in listConteudo" :key="index">
                                                <td class="text-right" style="max-width:55px; min-width:55px;">
                                ...
                                <q-tab-panel name="midias">
                                    ...
                                    <span class="text-h5">Facebook</span>
                                    <div class="row q-col-gutter-sm q-pa-md">
                                        <div class="col-sm-6 col-md-4 col-12">
                        ...
                        <h4>Google Maps</h4>
                                ...
                                <q-tab-panel name="layout">
                                    ...
                                    <div class="row q-col-gutter-sm q-pa-md">
                                        ...
                                        <div class="col-sm-6 col-md-2 col-12">
                                            <q-select label="Tipo Fundo" v-model="state.entidadeSite.pagina.tipoHeaderBackGround" :options="['Cor Sólida', 'Glossy', 'Gradiente', 'Banner']" outlined>
                                            </q-select>
                                        </div>
                                    ...
                                    <div class="row q-col-gutter-sm q-pa-md">
                                       <div class="col-sm-6 col-md-2 col-12">
                                            <q-select label="Tipo Fundo" v-model="state.entidadeSite.pagina.menuTipoBackGround" :options="['Cor Sólida', 'Glossy', 'Gradiente']" outlined>
                                            </q-select>
                                        </div>
